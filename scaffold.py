...
print("The mod group may also be updated. If you are not macuguita, please change this.")
print("Note: Be careful not to include reserved keywords- I do not check for them!")
mod_group = require_input(f"Mod Group: [com.macuguita]: ", 'com.macuguita', package_name_validator)
...
if remove_samples:
    ...
    # Mixins
    os.remove('src/main/java/com/macuguita/modtemplate/mixin/ExampleMixin.java')
    yeet_line('src/main/resources/modtemplate.mixins.json', 'ExampleMixin')
    # Datagen
    shutil.rmtree('src/main/generated', ignore_errors=True)
    os.remove('src/fabric/java/com/macuguita/modtemplate/datagen/ModRecipeProvider.java')
    yeet_line('src/fabric/java/com/macuguita/modtemplate/datagen/ModTemplateDataGenerator.java', 'sample_content')
    # AWs/ATs
    yeet_line('src/main/resources/modtemplate.classtweaker', 'sample_content')
...
if mod_class != 'ModTemplate':
    ...
    os.rename('src/main/java/com/macuguita/modtemplate/common/ModTemplate.java',
              f'src/main/java/com/macuguita/modtemplate/common/{mod_class}.java')
    print('Renaming Client Entrypoint Class File...')
    os.rename('src/main/java/com/macuguita/modtemplate/client/ModTemplateClient.java',
              f'src/main/java/com/macuguita/modtemplate/client/{mod_class}Client.java')
    print('Renaming Data Generator Class File...')
    os.rename('src/fabric/java/com/macuguita/modtemplate/datagen/ModTemplateDataGenerator.java',
              f'src/fabric/java/com/macuguita/modtemplate/datagen/{mod_class}DataGenerator.java')
    print('Renaming Neoforge Entrypoint Class File...')
    os.rename('src/neoforge/java/com/macuguita/modtemplate/impl/platform/neoforge/ModTemplateNeoMod.java',
              f'src/neoforge/java/com/macuguita/modtemplate/impl/platform/neoforge/{mod_class}NeoMod.java')

print('Renaming Resource Files...')
os.rename('src/main/resources/modtemplate.classtweaker',
          f'src/main/resources/{mod_id}.classtweaker')
...
MassReplace.replace('.', 'com.macuguita', mod_group)
...
move_package_group('src/main/java/', 'com.macuguita', mod_group)
move_package_group('src/fabric/java/', 'com.macuguita', mod_group)
move_package_group('src/neoforge/java/', 'com.macuguita', mod_group)
rename_modtemplate_dirs('src/main/java/', mod_id)
rename_modtemplate_dirs('src/fabric/java/', mod_id)
rename_modtemplate_dirs('src/neoforge/java/', mod_id)
